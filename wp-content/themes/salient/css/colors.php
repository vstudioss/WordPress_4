...
$external_dynamic = (!empty($options['external-dynamic-css']) && $options['external-dynamic-css'] == 1) ? 'on' : 'off';
	...
	if(!empty($options["extra-color-1"])) { 
		...
		body .dark .testimonial_slider[data-style="multiple_visible"][data-color*="extra-color-1"] blockquote .bottom-arrow:after { border-color:'.$options["extra-color-1"].'; }
	...
	if(!empty($options["extra-color-2"])) { 
		...
		body .dark .testimonial_slider[data-style="multiple_visible"][data-color*="extra-color-2"] blockquote .bottom-arrow:after { border-color:'.$options["extra-color-2"].'; }
	...
	if(!empty($options["extra-color-3"])) { 
		...
		body .dark .testimonial_slider[data-style="multiple_visible"][data-color*="extra-color-3"] blockquote .bottom-arrow:after { border-color:'.$options["extra-color-3"].'; }
